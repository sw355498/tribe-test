  ...
  <div class="list-group list-group-flush ">
   ...
   <?php foreach($rows_id as $value){ ?>
            ...
            <div class="mb-2">
                    ...
                    <input class="form-control-plaintext text-secondary" type="text" id="goodat" name="goodat" value="<?=$value["goodat"]?>" readonly >
            </div>
            <div class="mb-2">
               <label class="h5">證照</label>
               <input type="text" class="form-control-plaintext text-secondary" name="certificate" value="<?=$value["certificate"]?>"readonly>
            </div>
            <div class="mb-2">
            <label for="language" class="h5">語言</label>
               <!-- <div>
               <input type="text" class="form-control-plaintext text-secondary" name="language" value="<?=$value["language"]?>"readonly>
            </div> -->
            ...
            <div class="my-2">
               ...
               <div>
               <textarea id="intro" name="intro" rows="10" cols="80" maxlength="300" readonly class="text-secondary intro";><?=$value["intro"]?></textarea>
               </div>
            </div>
            <div class="mb-2">
               <label class="h5">匯款帳號</label>
               <input type="text" class="form-control-plaintext text-secondary" name="bank_account" value="<?=$value["bank_account"]?>" readonly>
            </div>
            <div class="mb-2">
               <div class="upload">
