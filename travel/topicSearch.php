...
$sqlTopic="SELECT * FROM topic WHERE id='$select'";
    $resultTopic=$db_host->prepare($sqlTopic);
    $resultTopic->execute();
    $topicSearch=$resultTopic->fetch(PDO::FETCH_ASSOC);
...
<div class="d-flex m-0">
    ...
    <!--content start-->
    <div class="flex-fill bt-light p-0">
        <div class=" bg-light p-4" style="min-height:100vh ">
            ...
            <div class="row d-flex mt-5" >
                ...
                <div class="ml-3 mt-4 d-flex">
                    ...
                    <span class="text-info h5 px-1"><?=$topicSearch["name"]?></span>的搜尋結果
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table 
                class="table-md table-bordered my-3 align-middle text-center table-striped"
                data-toggle="table"
                        ...
                        <tr>
                            ...
                            <td>   
                                <div class="d-flex flex-column">
                                    ...
                                    <a class="mb-1 btn btn-danger btn-sm text-nowrap" href="./php/viewpointDelete.php?id=<?=$value["id"]?>"><i class="fas fa-trash">刪除</i></a>
                                </div>
                            </td>
                        </tr>
                    <?php }?>
                ...
                <ul class="pagination justify-content-center mt-4">
                    <?php for($i=1; $i<=$pages; $i++){ ?>
                        <li class="page-item 
                            ...
                            <a class="page-link "  href="topicSearch.php?select=<?=$_GET["select"]?>&p=<?=$i?>"><?=$i?></a>
                        </li>            
                    <?php } ?>
                </ul>
              </nav> 
